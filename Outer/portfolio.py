...
def default_portfolio() -> list:
    """Four-worker portfolio: baseline dyn-on/off, beam worker, and floor worker."""
    # Fragmentation-delta evaluation hook: OGC_FRAGDELTA="w,queue_hi,horizon".
    fd = {}
    ...
    if _fd_env:
        try:
            ...
            fd = {}
    # Hull-nestle is enabled for dyn-on workers by default.
